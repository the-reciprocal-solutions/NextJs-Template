            ...
            <div className="col-lg-7">
              <div className="about-content-part rel z-2 rmb-55">
                <div className="section-title mb-35 wow fadeInUp delay-0-2s">
                  ...
                  <p>
                    From avant-garde haircuts that make a statement about your personality to rejuvenating hairBotox treatments that bring back your youthful glow, we offer a comprehensive range of services tailored to your needs. 
                  </p>
                </div>
